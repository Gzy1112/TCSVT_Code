...
def main(args):
    ...
    vgr_dataset = VG_Attribution(image_preprocess=image_processor, download=True, root_dir="/data/gongziyu/LLaVA-main/llava/serve/notebook/cache")
    ...
    for batch in tqdm_loader:
        ...
        bart_score = []
        for c_option in batch["caption_options"]: #2 sentence
        ...
        batch_scores = np.expand_dims(np.expand_dims(np.array(bart_score_final),axis=0),axis=0) # B x K x L #1,1,2
